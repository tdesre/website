...
SECRET_KEY = "django-insecure-h$t&&@y0pvn=(_)mko$9pu@g*nv902#dw4fg=r2&zlaxl_xzj1"
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # Vide, car on utilise les templates des applications
...
STATICFILES_DIRS = [
    BASE_DIR,
    BASE_DIR / "description/static",
    BASE_DIR / "catalogue" / "fruit_photos",
    BASE_DIR / "catalogue" / "leaf_photos"
    ]
